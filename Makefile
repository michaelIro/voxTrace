...
CapillaryTracer.o: src/CapillaryTracer.cpp
	$(HOST_COMPILER) $(XRAYLIB_CFLAGS) $(POLYCAP_CFLAGS) -I$(EASY_RNG_INCLUDE_DIR) $(LIBRARIES) $(INCLUDES) -o $(BUILD_DIR)/$@ -c $< $(ALT_CCFLAGS) $(POLYCAP_LFLAGS)
    #-lvt.base -lPolyCapAPI 

CapillaryTracer: $(BUILD_DIR)/CapillaryTracer.o
	$(HOST_COMPILER) $(XRAYLIB_CFLAGS) $(ALL_LDFLAGS) -I$(EASY_RNG_INCLUDE_DIR) -o $(BUILD_DIR)/$@ $+ $(LIBRARIES) $(ALT_CCFLAGS) $(POLYCAP_LFLAGS)

...
int main() {
	...
	sec_beam_mat.load(arma::hdf5_name("/media/miro/Data/pos-3.h5","my_data"));
    ...
    myDetectorBeam.getMatrix().save(arma::hdf5_name("/media/miro/Data/pos-3-detector.h5","my_data"));

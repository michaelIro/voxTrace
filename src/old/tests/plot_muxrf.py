...
Simulation:  test-data/out/muXRF_spectra.csv    (Z-scan, ±50 µm, normalised by N_RAYS)
"""
...
base_dir = os.path.dirname(os.path.dirname(ROOT))  # repo root (src/tests -> src -> root)
...
# ─────────────────────────────────────────────────────────────────────────────
sim_df   = pd.read_csv(os.path.join(base_dir, "test-data", "out", "muXRF_spectra.csv"))
...
plt.tight_layout()
out_png = os.path.join(base_dir, "test-data", "out", "muxrf_comparison.png")
